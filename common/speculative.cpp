...
struct common_speculative_impl_draft_mtp : public common_speculative_impl {
        ...
        , params(params.draft)
    {
        ...
        SPC_TRC("- n_max=%d, n_min=%d, p_min=%.2f, n_embd=%d, n_embd_hidden=%d, backend_sampling=%d, gemma4_asst=%d\n",
                this->params.n_max, this->params.n_min, this->params.p_min, n_embd, n_embd_hidden,
